...
-(void)detailPlayerButtonClick:(UIButton *)button
{
    switch (button.tag - 200) {
        ...
        {
            //食材准备
            PlayViewController * playerVC = [[PlayViewController alloc]initWithContentURL:[NSURL URLWithString:_model.material_video]];
            //准备播放
        ...
        {
            //制作步骤
            PlayViewController * playerVC = [[PlayViewController alloc]initWithContentURL:[NSURL URLWithString:_model.process_video]];
            //准备播放
            [playerVC.moviePlayer prepareToPlay];
            //播放
            [playerVC.moviePlayer play];
...
{
    PlayViewController * playerVC = [[PlayViewController alloc]initWithContentURL:[NSURL URLWithString:self.videoUrl]];
    //准备播放
    [playerVC.moviePlayer prepareToPlay];
    //播放
    [playerVC.moviePlayer play];
