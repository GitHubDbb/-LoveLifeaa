...
-(void)createUI
{
    ...
    _headerTielsLabel = [FactoryUI createLabelWithFrame:CGRectMake(0, _headerImageView.frame.size.height - 40, SCREEN_W, 40) text:nil textColor:[UIColor whiteColor] font:[UIFont systemFontOfSize:10]];
    [_headerImageView addSubview:_headerTielsLabel];
...
-(void)reloadHeaderView
{
    ...
    _headerTielsLabel.text = self.dataDic[@"desc"];
}
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    indexLabel.textAlignment = 1;
    [bgView addSubview:indexLabel];
    
    //标题
    UILabel * titleLabel = [FactoryUI createLabelWithFrame:CGRectMake(indexLabel.frame.size.width+indexLabel.frame.origin.x+10, 10, 100, 40) text:nil textColor:[UIColor darkGrayColor] font:[UIFont systemFontOfSize:18]];
