...
@implementation ArticolTableViewCell
...
-(void)createUI
{
    ...
    //时间
    _timeLabel = [FactoryUI createLabelWithFrame:CGRectMake(10, _imageView.frame.size.height+_imageView.frame.origin.y + 10, 120, 120) text:nil textColor:[UIColor lightGrayColor] font:[UIFont systemFontOfSize:12]];
    ...
    //标题
    _titleLabel = [FactoryUI createLabelWithFrame:CGRectMake(_imageView.frame.origin.x + _imageView.frame.size.width + 10, 30, 150, 40) text:nil textColor:[UIColor darkGrayColor] font:[UIFont systemFontOfSize:16]];
