...
//文字变色例子
//-(void)refreshUI:(FoodModel *)model index:(NSIndexPath*)indexdPath{
//    NSMutableAttributedString * string = [[NSMutableAttributedString alloc]initWithString:[NSString stringWithFormat:@"%ld:%@",(long)indexdPath.row + 1,model.title]];
//    if (indexdPath.row + 1>9) {
